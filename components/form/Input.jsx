    ...
    <div className='w-full'>
        <label className='relative block cursor-text w-full'>
          ...
          `} 
            ...
            {...inputProps}/>
            {type !== "datetime-local" && (
            <span className='absolute top-0 left-0 px-4 text-sm h-full flex items-center peer-focus:h-7 peer-focus:text-xs peer-valid:h-7 peer-valid:text-xs transition-all'>{placeholder}</span>)}            
        </label>
