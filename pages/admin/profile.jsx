    ...
    <div className="flex px-10 min-h-[calc(100vh_-_433px)] flex-col lg:flex-row lg:mb-0 mb-10">
      <div className="lg:w-80 w-full flex-shrink-0">
        ...
        <ul className="text-center font-semibold">
          ...
          <li className={`border border-t-0 w-full p-3 cursor-pointer hover:bg-primary hover:text-white transition-all ${tabs === 4 && "bg-primary text-white"} `} onClick={() => setTabs(4)}>
