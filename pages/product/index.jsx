...
const foodItems = [
    {
        ...
        name: "pizza 1",
        price: 10,
        description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis placeat pariatur vitae, minima numquam ut!",
        extraOptions: [
            {
                id: 1,
                name: "Extra 1",
...
const Index = () => {
  ...
  return (
    <div className='flex items-center md:h-[calc(100vh_-_88px)] gap-5 py-20 flex-wrap md:justify-between justify-center'>
        ...
        <div className='md:flex-1 md:text-start text-center'>
            ...
            <p className='text-sm my-4 md:pr-24'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi eius maxime iure consequuntur dolor ducimus illo distinctio alias perferendis minima ipsam et, omnis repudiandae voluptatibus ullam temporibus at laudantium illum.</p>
            <div>
            ...
            <div className='flex gap-x-4 my-6 md:justify-start justify-center'>
                {extraItems.map((item) => (
                    ...
                    <input type="checkbox" onChange={(e) => handleChange(e, item)} className='w-5 h-5 accent-primary'/>
